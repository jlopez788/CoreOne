...
public static class MemberExtensions
{
    ...
    public static IEnumerable<T> GetAttributes<T>(this MemberInfo? member, bool inherit = false) where T : Attribute => member?.GetCustomAttributes(typeof(T), inherit)?.Cast<T>() ?? Array.Empty<T>();
