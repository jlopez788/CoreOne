...
public sealed partial class StronglyTypedIdSourceGenerator : IIncrementalGenerator
{
    ...
    private sealed class AttributeInfo : IEquatable<AttributeInfo>
    {
        ...
        public bool IsDefaultCtorDefined { get; }
        ...
        public bool IsEmptyDefined { get; }
        ...
        public AttributeInfo(Compilation compilation, SyntaxNode attributeSyntax, INamedTypeSymbol typeSymbol, IdType idType, ITypeSymbol idTypeSymbol, StronglyTypedIdConverters converters, bool addCodeGeneratedAttribute, StringComparison stringComparison, bool generateToStringAsRecord)
        {
            ...
            foreach (var member in typeSymbol.GetMembers())
            {
                switch (member)
                {
                    ...
                    case IMethodSymbol { IsStatic: false, Name: ".ctor", Parameters.Length: 0 }:
                        IsDefaultCtorDefined = true;
                        break;
                    ...
                    case IPropertySymbol { IsStatic: true, Name: PropertyEmpty }:
                        IsEmptyDefined = true;
                        break;
            ...
            Declaration = typeSymbol switch {
                { TypeKind: TypeKind.Interface } => TypeDeclaration.Interface,
                { IsRecord: false, IsValueType: false } => TypeDeclaration.Class,
                { IsRecord: false, IsValueType: true } => TypeDeclaration.Struct,
                { IsRecord: true, IsValueType: false } => TypeDeclaration.Record,
                { IsRecord: true, IsValueType: true } => TypeDeclaration.RecordStruct
            };
        ...
        public bool Equals(AttributeInfo? other)
        {
            ...
            return other is not null
                ...
                && IsDefaultCtorDefined == other.IsDefaultCtorDefined
                ...
                && IsEmptyDefined == other.IsEmptyDefined
        ...
        public override int GetHashCode()
        {
            ...
            hash = (hash * 397) ^ IsDefaultCtorDefined.GetHashCode();
            ...
            hash = (hash * 397) ^ IsEmptyDefined.GetHashCode();
            ...
            hash = (hash * 397) ^ Declaration.GetHashCode();
            return hash;
        }
    ...
    private const string PropertyEmpty = "Empty";
    ...
    private static readonly string GeneratedCodeAttribute = $"[global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"CoreOne.Attributes.StronglyTypedId\", \"{Version}\")]";
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        var nonGenericTypes = context.SyntaxProvider
            .ForAttributeWithMetadataName(
                "CoreOne.Attributes.StronglyTypedIdAttribute",
        ...
        var genericTypes = context.SyntaxProvider
            .ForAttributeWithMetadataName(
                "CoreOne.Attributes.StronglyTypedIdAttribute`1",
    ...
    private static int BeginPartialContext(CSharpFileWriter writer, PartialTypeContext context, Action<CSharpFileWriter>? writeAttributes = null, string? baseTypes = null)
    {
    ...
    private static void Execute(SourceProductionContext context, object semanticContext)
    {
        ...
        void WriteAttributes(CSharpFileWriter writer)
        {
    ...
    private static void WriteNewMember(CSharpFileWriter writer, AttributeInfo info, bool addNewLine, XNode[]? xmlDocumentation = null)
    {
        if (addNewLine)
        {
            writer.WriteLine();
