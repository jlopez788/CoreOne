...
[AttributeUsage(AttributeTargets.Struct | AttributeTargets.Class, AllowMultiple = false)]
public sealed class StronglyTypedIdAttribute<T> : StronglyTypedIdAttribute
{
    ...
    public StronglyTypedIdAttribute(bool generateSystemTextJsonConverter = true,
                                    ...
                                    bool generateSystemComponentModelTypeConverter = true,
                                    bool generateMongoDBBsonSerialization = true,
                                    bool addCodeGeneratedAttribute = true) : base(typeof(T),
                                        generateSystemTextJsonConverter,
                                        generateNewtonsoftJsonConverter,
                                        generateSystemComponentModelTypeConverter,
                                        generateMongoDBBsonSerialization,
